...
export const pixelArtTemplates: Record<string, PixelArtTemplate> = {
  "heart": {
    name: "Heart",
...
export const pixelArtByTag: Record<string, string[]> = {};
...
export function getTemplateById(id: string): PixelArtTemplate | undefined {
  return pixelArtTemplates[id];
}

export function getTemplatesByTag(tag: string): PixelArtTemplate[] {

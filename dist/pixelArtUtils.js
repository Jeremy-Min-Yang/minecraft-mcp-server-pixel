 ...
 */
export function calculatePixelPositions(options) {
 ...
 */
export function countBlocksNeeded(pixels) {
    const counts = {};
 ...
 */
export function calculateOptimalBuildOrder(blocks) {
 ...
 */
export function validatePixelArt(pixels) {

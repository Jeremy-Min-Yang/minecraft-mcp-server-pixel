 ...
 */
export async function imageToPixelArt(imagePath, maxWidth = 300, maxHeight = 300) {
    try {
        // Get image metadata
 ...
 */
export async function imageToVerticalWall(imagePath, maxWidth = 300, maxHeight = 300) {
 ...
 * @returns Promise<string[][]> 2D array of Minecraft block names
 */
export async function imageBase64ToPixelArt(base64Data, maxWidth = 300, maxHeight = 300) {
    try {
 ...
 */
export async function imageBase64ToVerticalWall(base64Data, maxWidth = 300, maxHeight = 300) {
...
//# sourceMappingURL=imageToPixelArt.js.map